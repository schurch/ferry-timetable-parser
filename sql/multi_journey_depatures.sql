...
SELECT RL.RouteSectionId as RouteSectionId, FSPR.CommonName AS `From`, TSPR.CommonName AS `To`, VJ.DepatureHour AS Hour, VJ.DepatureMinute AS Minute, JPTL.RunTime AS RunTime, JPTL.WaitTime AS WaitTime
FROM RouteLink RL 
